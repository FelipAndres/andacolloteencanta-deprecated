...
<section class="position-2-1 grid--12-2">
  <div class="carta__container">
    ...
    <div class="carta--titulo emprendedor">
      <h3><?php the_title(); ?></h3>
    </div>
    <div class="carta--content">
      ...
      <div class="info-contacto carta--nombre"><img
          src="<?php echo get_template_directory_uri();  ?>/assets/images/user-alt-solid.svg" alt="">
        <p><?php echo $nombre;?></p>
      </div>
      <div class="info-contacto carta--direccion"><img
          src="<?php echo get_template_directory_uri();  ?>/assets/images/location-arrow-solid.svg" alt="">
        <p><?php echo $direccion;?></p>
      </div>
      <div class="info-contacto carta--telefono"><img
          src="<?php echo get_template_directory_uri();  ?>/assets/images/phone-alt-solid.svg" alt="">
    ...
    ?>
      ...
      <a href="<?php echo $email; ?>"><img src="<?php echo get_template_directory_uri();  ?>/assets/images/envelope-solid.svg"
          alt="" target="_blank"></a>
  ...
  <div class="icono--servicio">
    ...
    <h2 class="emprendedor-title">Productos</h2>
  </div>
  ...
  <aside class="aside--right emprendedor">
    <h1>Emprendedor Local</h1>
    <div class="sellos">
      <?php
