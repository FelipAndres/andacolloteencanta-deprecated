...
<section class="position-2-1 grid--12-2">
  <div class="carta__container">
    ...
    <div class="carta--titulo artesania">
      <h3><?php the_title(); ?></h3>
    </div>
    <div class="carta--content">
      ...
      <div class="info-contacto carta--nombre"><img src="<?php echo get_template_directory_uri();  ?>/assets/images/user-alt-solid.svg" alt=""> <p><?php echo $nombre;?></p></div>
      <div class="info-contacto carta--direccion"><img src="<?php echo get_template_directory_uri();  ?>/assets/images/location-arrow-solid.svg" alt=""> <p><?php echo $direccion;?></p></div>
      <div class="info-contacto carta--telefono"><img src="<?php echo get_template_directory_uri();  ?>/assets/images/phone-alt-solid.svg" alt=""> <p><?php echo "+569 " . $numero;?></p></div>
      <div class="info-contacto carta--correo"><img src="<?php echo get_template_directory_uri();  ?>/assets/images/envelope-solid.svg" alt=""><p><?php echo $email;?></p></div>
    </div>
    <div class="rrss">
    <?php
    ...
    ?>
      <a href="<?php echo $facebook; ?>"><img src="<?php echo get_template_directory_uri();  ?>/assets/images/facebook-brands.svg" alt="" ></a>
      <a href="<?php echo $instagram; ?>"><img src="<?php echo get_template_directory_uri();  ?>/assets/images/instagram-brands.svg" alt=""></a>
      <a href="<?php echo $email; ?>"><img src="<?php echo get_template_directory_uri();  ?>/assets/images/envelope-solid.svg" alt="" target="_blank"></a>
      <a href="<?php echo $whatsapp; ?>"><img src="<?php echo get_template_directory_uri();  ?>/assets/images/whatsapp-brands.svg" alt=""></a>
    </div>
  </div>
  <div class="icono--servicio">
    
    <img src="<?php echo get_template_directory_uri();  ?>/assets/images/icono-artesania.svg" alt="">
    <h2 class="artesania-title">Productos</h2>
  </div>
  ...
  <aside class="aside--right artesania">
