...
<section class="grid--single-perfil">
    ...
    <div class="info-perfil">
        <div class="info-perfil--content card-styles">
            <h1 class="artesania"><?php the_title(); ?></h1>
        ...
        <aside class="aside--right donde-comer">
            ...
            <img class="aside-r-img" src="<?php echo get_template_directory_uri();  ?>/assets/images/A.svg" alt="">
        </aside>

        <a class="justify-flex-end btn-posicion" href="<?php site_url(); ?>/categorias-perfiles/artesania">
