...
<section class="position-2-3 grid--12-3">
  ...
  <aside class="aside--noticias">
    <h1><?php the_title(); ?></h1>
    <figure>
      <img class="aside--n" src="<?php echo get_template_directory_uri();  ?>/assets/images/P.svg" alt="">
    </figure>
  </aside>
  ...
  <div class="copete__noticia">
    ...
    <div class="footer__datos-2">
      <img class="aside--n-2" src="<?php echo get_template_directory_uri();  ?>/assets/images/P.svg" alt="">
      <div class="flex-end">
